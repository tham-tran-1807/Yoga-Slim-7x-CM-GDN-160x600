...
lib.ssMetadata = [
		{name:"Yoga_Slim_7x_CM_GDN_160x600_atlas_1", frames: [[1296,0,50,50],[0,0,160,600],[162,0,160,600],[324,0,160,600],[486,0,160,600],[648,0,160,600],[810,0,160,600],[972,0,160,600],[1134,0,160,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Yoga_Slim_7x_CM_GDN_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.YogaSlim7xCMGDN160x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(181).to({_off:false},0).to({_off:true},59).wait(210));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120).to({_off:false},0).to({_off:true},61).wait(269));
...
// library properties:
lib.properties = {
	id: '3057D79332CB1041A08D0D242CCB271D',
	width: 160,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Yoga_Slim_7x_CM_GDN_160x600_atlas_1.png", id:"Yoga_Slim_7x_CM_GDN_160x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['3057D79332CB1041A08D0D242CCB271D'] = {
